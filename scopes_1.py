# Local Scope vs Global Scope visibility (variable initialized in both local and global scope)
#

def localScope():
    """Shows an example of local scope variable visibility.  

    Return nothing.  

    Arguments: no arguments.  
    """
    # Initialize the value of m with a random integer number, in the local scope of the function.
    #
    m= 7
